...
class View:
    ...
    def load_interface(self):
        ...
        self.pulsante_cammino_minimo = ft.ElevatedButton("Conta Cammino", width=200, on_click=self.controller.handle_cammino_minimo if self.controller else None)
        row3 = ft.Row([self.pulsante_cammino_minimo], alignment=ft.MainAxisAlignment.CENTER)
        self._lista_visualizzazione_3 = ft.ListView(expand=1, spacing=10, padding=20, auto_scroll=False)

        # --- Toggle Tema ---
        self.toggle_cambia_tema = ft.Switch(label="Tema scuro", value=True, on_change=self.cambia_tema)
        self.lista_visualizzazione_3 = ft.ListView(expand=1, spacing=10, padding=20, auto_scroll=False) #dove metto i dati
